...
namespace Servidor
{
    public partial class FrmMantenimientoViajes : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                Codigo = txtCodigoViaje.Text.ToUpper(),
            ...
            {
                MessageBox.Show("Este código de viaje ya existe", "Error",
                              MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            LimpiarCampos();
            //MostrarDisponibilidadEnGrid(nuevoViaje);

            // Mostrar disponibilidad inicial (para verificación)
            //MostrarDisponibilidad(nuevoViaje);
